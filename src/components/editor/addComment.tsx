...
const CommentAdd = ({
  ...
  const { AuthStatus, user, revalidationStatus, articleId, revalidate } =
  ...
  if (AuthStatus === "unauthenticated")
    return (
      <div className="flex items-center justify-center rounded-lg border py-4 shadow-sm hover:bg-gray-50 active:bg-gray-100">
