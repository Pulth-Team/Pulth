    ...
    <DashboardLayout>
      ...
      <div className="md:hidden block p-5">
        <Tab.Group selectedIndex={selectedIndex} onChange={setSelectedIndex}>
          ...
          <Tab.List className="w-full flex justify-between border-b-2">
            <Tab
              className={`${
          ...
          <Tab.Panels className="py-5">
            <Tab.Panel className="flex flex-col items-center gap-y-7">
              ...
              <div className="flex flex-col gap-y-3">
                ...
                ></Image>
                <button className="block bg-indigo-600 text-white p-2 rounded-lg font-semibold">
                  Change Image
                </button>
              </div>
              ...
              <div className="self-start flex flex-col gap-y-6 w-full">
                <div>
      ...
      <div className="hidden p-10 md:flex flex-col gap-y-10">
